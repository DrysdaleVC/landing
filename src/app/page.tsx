    ...
    <main className="min-h-[100vh] w-full flex items-center p-0 justify-center md:bg-background md:bg-none sm:bg-[url(/rough_plastic.webp)] bg-cover">
      ...
      >
        ...
        >
          <div
            data-id="screen"
            className="w-full h-full flex rounded-[20px] brightness-125 opacity-100 flex-col p-6 md:p-12 bg-[#f0f0e8] dark:bg-background relative overflow-hidden"
          >
            <div
              data-id="logo"
            ...
            >
              ...
              <div className="flex flex-col md:flex-row text-secondary justify-between w-full font-sans absolute z-10 -bottom-3 gap-4 md:gap-0">
