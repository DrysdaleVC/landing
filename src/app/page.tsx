  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-black">
      <div
        ...
        className="w-full absolute min-h-[800px] bg-[url(/rough_plastic.webp)] brightness-75 bg-center bg-cover max-w-7xl aspect-video flex flex-col justify-center md:p-16 rounded-xl"
      >
        <div
        ...
        <div className="size-12 hidden md:block absolute bottom-0 left-1/2 mb-2 mx-auto">
          <img
            src="/icon-dark.svg"
            alt="Drysdale Ventures Logo"
            className="size-12"
